...
par(mfrow = c(2, 2))
a[, plot(time, global_active_power, type = "l", xlab = "", ylab = "Global Active Power")]
a[, plot(time, voltage, type = "l", xlab = "datetime", ylab = "Voltage")]
...
a[, plot(time, global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")]
dev.off()